                        ...
                        <?php if (!empty($data['data'])): ?>
                            <?php foreach ($data['data'] as $note): ?>
                                ...
                                <div class="note-sheet note-sheet-label d-flex"
                                     ...
                                     data-is-protected="<?= htmlspecialchars($note['isProtected'])?>"
                                    ...
                                    <div class="note-sheet__menu">
                                        <div class="note-sheet__menu--item">
                                            ...
                                            <?php if (!empty($note['isProtected']) && $note['isProtected']): ?>
                                                <button class="note-lock-btn" title="This note is locked">
                                                    <i class="fa-solid fa-lock"></i>
                                                </button>
                                            <?php else: ?>
                                                <button class="note-lock-btn" title="This note is unlocked">
